...
class ScreenBlueCard extends StatefulWidget {
  const ScreenBlueCard({super.key, required});

  @override
  State<ScreenBlueCard> createState() => _ScreenBlueCardState();
}

class _ScreenBlueCardState extends State<ScreenBlueCard> {
  @override
